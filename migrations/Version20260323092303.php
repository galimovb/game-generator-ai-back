 ...
 */
final class Version20260323092303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_settings (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, generation_model VARCHAR(255) NOT NULL, generation_creative DOUBLE PRECISION NOT NULL, owner_id INT NOT NULL, PRIMARY KEY (id))');
